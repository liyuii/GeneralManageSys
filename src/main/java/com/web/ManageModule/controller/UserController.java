...
//        List<auth_user> userList = userService.userPage(queryCmd);
//        PageInfo<auth_user> page = new PageInfo<>(userList);
//
...
//        auth_user user = userService.getUserById(userId);
//        map.put("user",user);
...
//    @ResponseBody
//    public Result addUser(auth_user user){
...
//    @ResponseBody
//    public Result updateUser(auth_user user){
//        Result result = new Result();
